...
<!--------------add an "update" and "delete" button for each user-->
          <div class="p2">
...
Vue.component("user-overview", {
  ...
  data: () => ({
    ...
    /*Having added a record, it would be nice to see the add form disappear again.
    It would also be nice, when we navigate to the /users endpoint,
    if the user form was collapsed too.*/
    hideForm :true,
